...
First, clone the abigail-device repo and download the wifi-setup dependencies from npm:

```
$ git clone https://github.com/mozilla/abigail-device
$ cd abigail-device/wifi-setup
$ npm install
```
